...
T = TypeVar("T", bound="AdminCreateStartBotBotRequestDto")


@_attrs_define
class AdminCreateStartBotBotRequestDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        admin_create_start_bot_bot_request_dto = cls(
            is_default_bot=is_default_bot,
            keywords=keywords,
        )

        return admin_create_start_bot_bot_request_dto
