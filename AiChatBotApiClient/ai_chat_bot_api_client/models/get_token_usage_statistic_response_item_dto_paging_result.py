...
if TYPE_CHECKING:
    from ..models.get_token_usage_statistic_response_item_dto import GetTokenUsageStatisticResponseItemDto


T = TypeVar("T", bound="GetTokenUsageStatisticResponseItemDtoPagingResult")


@_attrs_define
class GetTokenUsageStatisticResponseItemDtoPagingResult:
    """
    Attributes:
        ...
        items (Union[List['GetTokenUsageStatisticResponseItemDto'], None, Unset]):
    """
    ...
    items: Union[List["GetTokenUsageStatisticResponseItemDto"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_items(data: object) -> Union[List["GetTokenUsageStatisticResponseItemDto"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = GetTokenUsageStatisticResponseItemDto.from_dict(items_type_0_item_data)
                ...
                pass
            return cast(Union[List["GetTokenUsageStatisticResponseItemDto"], None, Unset], data)

        items = _parse_items(d.pop("items", UNSET))

        get_token_usage_statistic_response_item_dto_paging_result = cls(
        ...
        return get_token_usage_statistic_response_item_dto_paging_result
