...
if TYPE_CHECKING:
    from ..models.get_bots_response_item_dto import GetBotsResponseItemDto


T = TypeVar("T", bound="GetBotsResponseItemDtoPagingResult")


@_attrs_define
class GetBotsResponseItemDtoPagingResult:
    """
    Attributes:
        ...
        items (Union[List['GetBotsResponseItemDto'], None, Unset]):
    """
    ...
    items: Union[List["GetBotsResponseItemDto"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_items(data: object) -> Union[List["GetBotsResponseItemDto"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = GetBotsResponseItemDto.from_dict(items_type_0_item_data)
                ...
                pass
            return cast(Union[List["GetBotsResponseItemDto"], None, Unset], data)

        items = _parse_items(d.pop("items", UNSET))

        get_bots_response_item_dto_paging_result = cls(
        ...
        return get_bots_response_item_dto_paging_result
