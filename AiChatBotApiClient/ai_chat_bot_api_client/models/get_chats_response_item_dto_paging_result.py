...
if TYPE_CHECKING:
    from ..models.get_chats_response_item_dto import GetChatsResponseItemDto


T = TypeVar("T", bound="GetChatsResponseItemDtoPagingResult")


@_attrs_define
class GetChatsResponseItemDtoPagingResult:
    """
    Attributes:
        ...
        items (Union[List['GetChatsResponseItemDto'], None, Unset]):
    """
    ...
    items: Union[List["GetChatsResponseItemDto"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_items(data: object) -> Union[List["GetChatsResponseItemDto"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = GetChatsResponseItemDto.from_dict(items_type_0_item_data)
                ...
                pass
            return cast(Union[List["GetChatsResponseItemDto"], None, Unset], data)

        items = _parse_items(d.pop("items", UNSET))

        get_chats_response_item_dto_paging_result = cls(
        ...
        return get_chats_response_item_dto_paging_result
