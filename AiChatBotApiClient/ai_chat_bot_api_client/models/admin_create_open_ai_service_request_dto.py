...
T = TypeVar("T", bound="AdminCreateOpenAiServiceRequestDto")


@_attrs_define
class AdminCreateOpenAiServiceRequestDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        admin_create_open_ai_service_request_dto = cls(
        ...
        return admin_create_open_ai_service_request_dto
