...
T = TypeVar("T", bound="UpdateChatUserSystemMessageRequestDto")


@_attrs_define
class UpdateChatUserSystemMessageRequestDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_chat_user_system_message_request_dto = cls(
            user_system_message_id=user_system_message_id,
        )

        return update_chat_user_system_message_request_dto
