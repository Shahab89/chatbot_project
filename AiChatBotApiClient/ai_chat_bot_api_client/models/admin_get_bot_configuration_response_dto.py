...
T = TypeVar("T", bound="AdminGetBotConfigurationResponseDto")


@_attrs_define
class AdminGetBotConfigurationResponseDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        admin_get_bot_configuration_response_dto = cls(
            configuration_raw=configuration_raw,
        )

        return admin_get_bot_configuration_response_dto
