...
if TYPE_CHECKING:
    from ..models.admin_get_bot_facts_response_item_dto import AdminGetBotFactsResponseItemDto


T = TypeVar("T", bound="AdminGetBotFactsResponseItemDtoPagingResult")


@_attrs_define
class AdminGetBotFactsResponseItemDtoPagingResult:
    """
    Attributes:
        ...
        items (Union[List['AdminGetBotFactsResponseItemDto'], None, Unset]):
    """
    ...
    items: Union[List["AdminGetBotFactsResponseItemDto"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_items(data: object) -> Union[List["AdminGetBotFactsResponseItemDto"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = AdminGetBotFactsResponseItemDto.from_dict(items_type_0_item_data)
                ...
                pass
            return cast(Union[List["AdminGetBotFactsResponseItemDto"], None, Unset], data)

        items = _parse_items(d.pop("items", UNSET))

        admin_get_bot_facts_response_item_dto_paging_result = cls(
        ...
        return admin_get_bot_facts_response_item_dto_paging_result
