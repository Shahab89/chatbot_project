...
T = TypeVar("T", bound="AdminCreateBotFactRequestDto")


@_attrs_define
class AdminCreateBotFactRequestDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        admin_create_bot_fact_request_dto = cls(
            is_active=is_active,
            fact_text=fact_text,
        )

        return admin_create_bot_fact_request_dto
