...
if TYPE_CHECKING:
    from ..models.get_user_system_messages_response_item_dto import GetUserSystemMessagesResponseItemDto


T = TypeVar("T", bound="GetUserSystemMessagesResponseItemDtoPagingResult")


@_attrs_define
class GetUserSystemMessagesResponseItemDtoPagingResult:
    """
    Attributes:
        ...
        items (Union[List['GetUserSystemMessagesResponseItemDto'], None, Unset]):
    """
    ...
    items: Union[List["GetUserSystemMessagesResponseItemDto"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_items(data: object) -> Union[List["GetUserSystemMessagesResponseItemDto"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = GetUserSystemMessagesResponseItemDto.from_dict(items_type_0_item_data)
                ...
                pass
            return cast(Union[List["GetUserSystemMessagesResponseItemDto"], None, Unset], data)

        items = _parse_items(d.pop("items", UNSET))

        get_user_system_messages_response_item_dto_paging_result = cls(
        ...
        return get_user_system_messages_response_item_dto_paging_result
