...
T = TypeVar("T", bound="AdminCreateBotRequestDto")


@_attrs_define
class AdminCreateBotRequestDto:
    """
    Attributes:
        ...
        is_start_bot (Union[None, Unset, bool]):
    """
    ...
    is_start_bot: Union[None, Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        is_start_bot: Union[None, Unset, bool]
        if isinstance(self.is_start_bot, Unset):
            is_start_bot = UNSET
        else:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_is_start_bot(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        is_start_bot = _parse_is_start_bot(d.pop("isStartBot", UNSET))

        admin_create_bot_request_dto = cls(
            code=code,
        ...
        return admin_create_bot_request_dto
